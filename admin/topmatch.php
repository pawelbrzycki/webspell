...
safe_query("INSERT INTO ".PREFIX."topmatch (date, matchlink, league, maps, server, statement, headline, teamclan, country1, team1, homepage1, country2, team2, homepage2, displayed)
	             values('$date', '$matchlink', '$league', '$maps', '$server', '$statement', '$headline', '$teamclan','$country1', '$team1', '$homepage1', '$country2', '$team2', '$homepage2', '$displayed' )");
