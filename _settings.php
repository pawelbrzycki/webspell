...
mysql_connect($host, $user, $pwd) or system_error('BŁĄD: Nie można się połączyć z serwerem MySQL');
mysql_select_db($db) or system_error('BŁĄD: Nie można się połączyć z bazą danych "'.$db.'"');
