...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td height="500" align="center"><table width="350" border="0" cellpadding="10" cellspacing="0" style="border:1px solid <?php echo BORDER; ?>" bgcolor="<?php echo BG_1; ?>">
        <tr>
          <td align="center"><img src="images/logo.png"alt="" class="logo" /><br />
            <h1><?php echo $error; ?></h1></td>
        </tr>
      </table></td>
  </tr>
</table>
